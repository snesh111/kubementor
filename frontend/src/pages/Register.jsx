...
export const Register = () => {
  ...
  const { register, googleLogin, githubLogin, isAuthenticated, loading, error, clearError } = useAuth();
  ...
  }, [isAuthenticated, navigate, from, githubLogin]);
  ...
  return (
    <div className="w-full max-w-[420px] mx-auto rounded-2xl bg-[#090d14]/95 border border-[#1e293b] p-8 shadow-2xl backdrop-blur-md space-y-6 text-center font-sans">
      ...
      <div className="pt-2 border-t border-slate-800/80">
        ...
        >
          {showEmailForm ? 'Hide manual registration' : 'Or register with email & password'}
        </button>
          ...
          <form className="space-y-3.5 mt-4 text-left" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="w-full bg-[#05080e] border border-slate-800 rounded-lg px-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-emerald-500 font-medium"
              />
            </div>
