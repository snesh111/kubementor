...
export const ValidationModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fadeIn select-none">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full shadow-2xl overflow-hidden flex flex-col max-h-[90vh] text-slate-100 font-sans">
        {/* HEADER BAR */}
          ...
          {!isValidating && result && (
            <>
              ...
              >
                ...
                {/* Score badge */}
                <div className="bg-slate-950/80 px-4 py-2 rounded-xl border border-slate-800 flex items-center gap-3 shrink-0">
                ...
                <>
                  {onSwitchToAI && (
                    <Button
                      ...
                      className="text-cyan-300 hover:text-cyan-200 hover:bg-cyan-500/10 border-cyan-500/30 flex items-center gap-2"
                    >
