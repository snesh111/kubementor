...
export const ScratchpadPane = ({ session, onSelectTab }) => {
  ...
  return (
    <div className="flex-1 bg-slate-950 rounded-xl border border-slate-800 flex flex-col overflow-hidden font-sans text-xs shadow-2xl">
      ...
      <div className="bg-slate-900/90 px-4 py-2.5 border-b border-slate-800 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-cyan-400 text-[11px] font-mono flex items-center gap-1 transition-colors"
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="space-y-1.5 bg-slate-900/40 p-3.5 rounded-xl border border-slate-800/80">
          ...
          <p className="text-[11px] text-slate-400 leading-snug">
            What anomalies did you observe in <code className="text-cyan-400">kubectl get pods</code>, <code className="text-cyan-400">kubectl describe</code>, or <code className="text-cyan-400">kubectl logs</code>?
          </p>
          <textarea
            rows={3}
            ...
            className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-cyan-500 font-mono leading-relaxed"
          />
        </div>
        ...
        <div className="space-y-1.5 bg-slate-900/40 p-3.5 rounded-xl border border-slate-800/80">
          ...
          <textarea
            ...
            className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-cyan-500 font-sans leading-relaxed"
          />
        </div>
        ...
        <div className="space-y-1.5 bg-slate-900/40 p-3.5 rounded-xl border border-slate-800/80">
          <div className="flex items-center justify-between">
            <label className="text-xs font-bold font-mono text-blue-300 flex items-center gap-1.5">
