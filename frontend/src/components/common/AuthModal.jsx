...
export const AuthModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200 select-none font-sans">
      {/* Click outside backdrop */}
      <div className="absolute inset-0" onClick={onClose} />

      {/* Main Modal Card */}
      <div className="relative z-10 w-full max-w-[420px] rounded-2xl bg-[#090d14]/95 border border-[#1e293b] p-7 sm:p-8 shadow-2xl backdrop-blur-xl text-center font-sans animate-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {(error || localError) && (
          <div className="mb-4 p-3 bg-rose-500/10 border border-rose-500/30 rounded-xl text-rose-400 text-xs flex items-center justify-center gap-2 text-left">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-[#e3e5e8] hover:bg-white text-slate-900 font-bold text-xs transition-all shadow-md flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-60 cursor-pointer"
          >
            {oauthLoading === 'google' ? (
          ...
          <button
            ...
            disabled={loading || !!oauthLoading}
            className="w-full py-3 px-4 rounded-xl bg-[#141922] hover:bg-[#1a212e] text-white font-bold text-xs border border-slate-700/80 hover:border-slate-600 transition-all shadow-md flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-60 cursor-pointer"
          >
            {oauthLoading === 'github' ? (
        ...
        {/* 4. Optional Email/Password Collapsible Dropdown */}
